...
import { type EmailPluginOptions, type UserPluginEmailSender } from "../interfaces/types.js";
export declare class EmailSenderHandler {
    ...
    constructor(options: EmailPluginOptions, authHandler: PassauthHandler<UserPluginEmailSender>);
    ...
    login<T extends UserPluginEmailSender>(params: LoginParams, jwtUserFields?: Array<keyof T>): Promise<{
        accessToken: string;
        refreshToken: string;
    }>;
...
export declare const EmailPlugin: (options: EmailPluginOptions, authHandler: PassauthHandler<UserPluginEmailSender>) => EmailSenderHandler;
