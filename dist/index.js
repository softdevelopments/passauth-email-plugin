...
export const EmailSenderPlugin = (options) => {
    return {
        ...
        handlerInit: (components) => {
            ...
            passauthHandler.register = (...args) => emailSenderHandler.register(...args);
            passauthHandler.confirmEmail = (...args) => emailSenderHandler.confirmEmail(...args);
            passauthHandler.confirmResetPassword = (...args) => emailSenderHandler.confirmResetPassword(...args);
            passauthHandler.sendConfirmPasswordEmail = (...args) => emailSenderHandler.sendConfirmPasswordEmail(...args);
            passauthHandler.sendResetPasswordEmail = (...args) => emailSenderHandler.sendResetPasswordEmail(...args);
        },
